...
function Contact() {
 ...
 const [data,setData]=useState({fullname:'',phone:'',email:'',msg:'',});
    ...
    return (
        <>
            ...
            <div className="container contact_div">
                <div className="row">
                    <div className="col-ms-6 col-10 mx-auto">
                        <form onSubmit={formsubmit}>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="exampleFormControlInput1" name="phone" value={data.phone} onChange={InputEvent} placeholder="Enter phone" required />
                            </div>
                            <div class="mb-3">
